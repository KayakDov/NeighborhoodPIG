...
public:
     ...
     */
    __device__ Pixel(int vecIndex, bool isRowTraversal, double* sourceMat, double* targetMat, int height, int targetInc) 
     ...
     */
    __device__ double sourceValue(int offset) {
     ...
     */
    __device__ double& targetValue(int offset) {        
