...
1.  Download the `NeighborhoodPIG.jar` file from the `dist/` folder of this repository.
...
![Screenshot of Donut's image open in Fiji](path/to/your/donut_derriere.png)
...
![Neighborhood PIG Plugin Dialog Screenshot](path/to/your/neighborhood_pig_dialog.png)
...
1.  **Heatmap:**
    ...
    * **Sample Output:**
        ![Donut's Orientation Heatmap](path/to/your/donut_heatmap.png)
...
2.  **VectorField:**
    ...
    * **Sample Output:**
        ![Donut's Nematic Vector Field](path/to/your/donut_vectorfield.png)
...
3.  **Generate Coherence:**
    ...
    * **Sample Output:**
        ![Donut's Coherence Heatmap](path/to/your/donut_coherence.png "Sample Coherence Heatmap")
...
![A Slice from a 3D Bacteria Image](path/to/your/3d_bacteria_slice.png)
*Figure 6: A slice of a 3D bacteria image (left) and the heat maps it may generate.*
...
![Vector Field Options Dialog](path/to/your/vectorfield_options_dialog.png "Vector Field Specific Options Dialog")
...
![Overlay of Donut's Image](path/to/your/donut_overlay.png)
...
* In the 3D Viewer window, you can rotate, zoom, and adjust rendering options to visualize your 3D data, including the vector field.
    * **Sample 3D Vector Field (in 3D Viewer):**
        ![3D Vector Field of Bacteria Culture in Fiji's 3D Viewer](path/to/your/3d_vectorfield_viewer_sample.png "Example of a 3D Vector Field viewed in Fiji's 3D Viewer")
...
![3D Vector Field Generated by a Cylinder](path/to/your/cylinder_vectorfield.png)
    *Figure 10: A 3D vector field generated by a cylinder.*  
